...
const csvData = `productID,productName,supplierID,categoryID,quantityPerUnit,unitPrice,unitsInStock,unitsOnOrder,reorderLevel,discontinued
...
const App = () => {
  ...
  const [data, setData] = useState(parseCSVData(csvData));
  ...
  return (
    <div style={{ fontFamily: 'Arial, sans-serif', maxWidth: '800px', margin: '0 auto', padding: '20px' }}>
      ...
      <select onChange={(e) => executeQuery(e.target.value)}>
